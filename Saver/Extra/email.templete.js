const welcomeEmailTemplate = (firstName) => {
    ...
    <head>
      ...
      <title>Welcome to Kash bank!</title>
    </head>
    <body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333333; margin: 0; padding: 0; -webkit-text-size-adjust: 100%; -ms-text-size-adjust: 100%;">
      <div style="width: 100%; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #dddddd; border-radius: 10px; background-color: #f9f9f9;">
        <div style="padding: 20px; background-color: #ffffff; border-radius: 10px;">
          ...
          <ul>
            <li><a href="https://kashbank.vercel.app/" style="color: #1E90FF;">Getting Started Guide</a></li>
          </ul>
          ...
          <a href="https://kashbank.vercel.app/" style="display: inline-block; padding: 10px 20px; margin-top: 20px; border-radius: 5px; background-color: #1E90FF; color: #ffffff; text-decoration: none;">Visit Our Website</a>
        </div>
    ...
    <body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333333; margin: 0; padding: 0; -webkit-text-size-adjust: 100%; -ms-text-size-adjust: 100%;">
      <div style="width: 100%; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #dddddd; border-radius: 10px; background-color: #f9f9f9;">
        <div style="padding: 20px; background-color: #ffffff; border-radius: 10px;">
          ...
          <a href="https://kashbank.vercel.app/verify?token=${verificationCode}" style="display: inline-block; padding: 10px 20px; margin-top: 20px; border-radius: 5px; background-color: #1E90FF; color: #ffffff; text-decoration: none;">Verify Your Account</a>
          <p>If the button above does not work, you can also verify your account by clicking the following link:</p>
          <p><a href="https://kashbank.vercel.app/verify?token=${verificationCode}" style="color: #1E90FF;">https://kashbank.vercel.app/verify?token=${verificationCode}</a></p>
